...
### control_center_logredactor_enabled
...
### control_center_logredactor_rule_path_local
...
### control_center_logredactor_rule_path
...
### kafka_broker_logredactor_enabled

Boolean to enable logredactor for kafka_broker. Defaults to logredactor_enabled. Works only when kafka_broker_custom_log4j is set to true

Default:  "{{ logredactor_enabled }}"

***

### kafka_broker_logredactor_rule_path_local

Location of the kafka_broker logredactor rules file on the control node. This'll be copied to kafka_broker_logredactor_rule_path on the kafka_broker node. 

Default:  "{{ logredactor_rule_path_local }}"

***

### kafka_broker_logredactor_rule_path

Full path and name of the rules file on kafka_broker node. This is the location which will be referenced in the log4j property file when defining the redactor appender.
...
### kafka_connect_logredactor_enabled
...
### kafka_connect_logredactor_rule_path_local
...
### kafka_connect_logredactor_rule_path
...
### kafka_rest_logredactor_enabled

Boolean to enable logredactor for kafka_rest. Defaults to logredactor_enabled. Works only when kafka_rest_custom_log4j is set to true

Default:  "{{ logredactor_enabled }}"

***

### kafka_rest_logredactor_rule_path_local

Location of the kafka_rest logredactor rules file on the control node. This'll be copied to kafka_rest_logredactor_rule_path on the kafka_rest node. 

Default:  "{{ logredactor_rule_path_local }}"

***

### kafka_rest_logredactor_rule_path

Full path and name of the rules file on kafka_rest node. This is the location which will be referenced in the log4j property file when defining the redactor appender.
...
### ksql_logredactor_enabled

Boolean to enable logredactor for ksql. Defaults to logredactor_enabled. Works only when ksql_custom_log4j is set to true

Default:  "{{ logredactor_enabled }}"

***

### ksql_logredactor_rule_path_local

Location of the ksql logredactor rules file on the control node. This'll be copied to ksql_logredactor_rule_path on the ksql node. 

Default:  "{{ logredactor_rule_path_local }}"

***

### ksql_logredactor_rule_path

Full path and name of the rules file on ksql node. This is the location which will be referenced in the log4j property file when defining the redactor appender.
...
### schema_registry_logredactor_enabled

Boolean to enable logredactor for schema_registry. Defaults to logredactor_enabled. Works only when schema_registry_custom_log4j is set to true

Default:  "{{ logredactor_enabled }}"

***

### schema_registry_logredactor_rule_path_local

Location of the schema_registry logredactor rules file on the control node. This'll be copied to schema_registry_logredactor_rule_path on the schema_registry node. 

Default:  "{{ logredactor_rule_path_local }}"

***

### schema_registry_logredactor_rule_path

Full path and name of the rules file on schema_registry node. This is the location which will be referenced in the log4j property file when defining the redactor appender.
...
### zookeeper_logredactor_rule_path_local
...
### zookeeper_logredactor_rule_path
